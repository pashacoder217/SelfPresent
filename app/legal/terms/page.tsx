...
const LegalTermsOfService: React.FC = () => {
  return (
    <div className="prose mx-auto py-8">
      <h1>Terms of Service (&quot;Terms&quot;)</h1>
      <p>
        <strong>Last updated: Friday, June 14th, 2024</strong>
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to Self Represent AI.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Self Represent AI, accessible from{" "}
          <a href="https://selfrepresent.ai/">https://selfrepresent.ai/</a>
        </li>
        <li>
      ...
      <p>
        The Company does not offer refunds for any subscriptions or services
        purchased. We provide a multi-day free trial period during which You can
        use the Service without any charge. By subscribing to our Service, You
        acknowledge and agree that all sales are final and non-refundable.
      </p>
      ...
      <p>
        ...
        copyright agent via email (help@selfrepresent.ai) and include in Your
      ...
      <p>
        You can contact our copyright agent via email (help@selfrepresent.ai).
      ...
      <ul>
        ...
        <li>
          ...
          <a href="mailto:help@selfrepresent.ai">help@selfrepresent.ai</a>
        </li>
      </ul>
    </div>
  );
