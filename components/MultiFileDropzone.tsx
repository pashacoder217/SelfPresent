// components/MultiFileDropzone.tsx
          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-neutral-400">
                ...
                <h3 className="bg-gradient-to-r from-neutral-400 to-neutral-300 bg-clip-text text-sm text-transparent">
                  Add documents{' '}
                </h3>
                <div className=" bg-gradient-to-r from-neutral-400 to-neutral-300 bg-clip-text text-transparent">
