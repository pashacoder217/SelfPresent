...
import { Dialog, DialogContent } from '@/SelfPresent/components/ui/dialog';
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3" cmdk-input-wrapper="">
    <MagnifyingGlassIcon className="ml-6 mr-2 h-4 w-4 shrink-0 opacity-50" />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-sm bg-gradient-to-r px-2 py-1.5 text-sm outline-none aria-selected:bg-neutral-100 aria-selected:from-neutral-100 aria-selected:via-neutral-100 aria-selected:to-neutral-200 aria-selected:text-neutral-900 data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 dark:aria-selected:from-neutral-900 dark:aria-selected:via-neutral-800 dark:aria-selected:to-neutral-800 dark:aria-selected:text-neutral-50',
      className
    )}
    {...props}
  />
