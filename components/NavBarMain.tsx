...
const NavBarMain = () => {
  return (
    <nav className="sticky top-0 z-50 flex h-12 items-center justify-between border-b border-neutral-800/10 bg-white/5 px-6 backdrop-blur-sm dark:border-neutral-100/10 dark:bg-black/5 md:px-10">
      <div className="">
        <Link href="/" className="flex items-center gap-0 pt-1 font-semibold">
          {/* <LogoIconBlink /> */}
          <div className="flex h-5 w-7 justify-end rounded bg-gradient-to-r from-neutral-600 to-neutral-950 shadow-sm dark:from-neutral-100 dark:to-neutral-400">
